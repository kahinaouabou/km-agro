  ...
  <div class="row">
    ...
    <div class="col-sm-7">
      <div class="form-group{{ $errors->has('pivot_id') ? ' has-danger' : '' }}">
        <select class="form-control{{ $errors->has('pivot_id') ? ' is-invalid' : '' }}" name="pivot_id" id="input-pivot" type="select" placeholder="{{ __('Pivot') }}" onchange="getDeliveryBillReference()" required>
