  ...
  <div class="modal-dialog">
        <div class="modal-content" >
            <div class="modal-header">
                <h4 class="modal-title">{{__("Add third party")}}</h4>
            ...
            @method('post')
                <div class="modal-body">
                    ...
                    <div class="col-sm-7">
                        ...
                        <input class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" id="input-address" type="text" placeholder="{{ __('Address') }}"  required="true" aria-required="true"/>
