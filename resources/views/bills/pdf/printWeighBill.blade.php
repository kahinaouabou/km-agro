<div style="width: 500px; margin-left : 130px; margin-bottom :100px; margin-top:50px">
...
<table width="100%">
    <tr>
        <td>
            <p style="font-size:18px"><strong>{{__('Product')}} :</strong> {{$bill->product->name}}</p>
        </td>
        ...
        <td>
            <p style="font-size:18px"><strong>{{__('Room')}} :</strong>{{$bill->room->name}}</p>
        </td>
