...
<body>
  ...
  <table width="100%">
    ...
    <tr style="height:10px; ">
      <td style='  width:300px; height:10px!important; padding:0; margin:0;'>
        <p style="font-size:16px ;"><strong>{{__('Total ').__('Nb boxes')}} :</strong></p>
      </td>
      <td>
        <p> {{number_format($countNbBoxes, 0, ',', ' ');}}</p>
      </td>
