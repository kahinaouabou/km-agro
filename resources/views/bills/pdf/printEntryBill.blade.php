...
<table width="100%">
  <tr>
    ...
    ?>
    <td>
      <p style="font-size:18px;"><strong>{{__('Product')}} :</strong><span style="font-family: DejaVu Sans, sans-serif; !important;"><?php echo $text ?></span> (PDT Semence)</p>
    </td>
...
<table width="100%">
  <tr>
    <td>
      <p style="font-size:18px;  width:200px"><strong>{{__('Départ')}} :</strong> Hassi lefhel W.Ménéa</p>
    </td>

    <td>
      <p style="font-size:18px; width:350px "><strong>{{__('Destinataire')}} :</strong>Entrepôt HAOUCHINE Farid K.E.K W.Boumerdes</p>
    </td>
...
<table width="100%">
  <tr>
    <td>
      <p style="font-size:18px"><strong>{{__('Chauffeur')}} :</strong>{{$bill->driver->name}}</p>
    </td>

    <td>
      <p style="font-size:18px; margin-left:200px"><strong>{{__('Registration')}} :</strong>{{$bill->truck->registration}}</p>
    </td>
