...
<table width="100%">
  <tr>
    ...
    ?>
    <td>
      <p style="font-size:18px;"><strong>{{__('Product')}} :</strong><span style="font-family: DejaVu Sans, sans-serif; !important;"><?php echo $text ?></span> ({{$bill->product->name}})</p>
    </td>
...
<table width="100%">
  ...
  <tr>
    ...
    <td>
      <p style="font-size:18px; "><strong>{{__('Registration')}} :</strong>{{$bill->truck->registration}}</p>
    </td>
