@extends('layouts.app', ['activePage' => 'parcel', 'titlePage' => __('Add parcel')])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('parcels.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')

            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Add parcel') }}</h4>
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('address') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" id="input-name" type="text" placeholder="{{ __('Address') }}"  required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('parcel_category_id') ? ' has-danger' : '' }}">
                      <select class="form-control{{ $errors->has('parcel_category_id') ? ' is-invalid' : '' }}" name="parcel_category_id" id="input-parcel-category" type="select" placeholder="{{ __('Category') }}" required >
                      <option value="">{{ __('Select category') }}</option>
                        @foreach($parcelCategries as $category)
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('third_party_id') ? ' has-danger' : '' }}">
                      <select class="form-control{{ $errors->has('third_party_id') ? ' is-invalid' : '' }}" name="third_party_id" id="input-third-party" type="select" placeholder="{{ __('Third party') }}"  >
                      <option value="">{{ __('Select third party') }}</option>
