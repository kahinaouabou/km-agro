<div class="sidebar" data-color="orange" data-background-color="white" data-image="{{ asset('material') }}/img/sidebar-1.jpg">
  ...
  <div class="sidebar-wrapper">
    <ul class="nav">
      ...
      <li class="nav-item{{ $activePage == 'variety' ? ' active' : '' }}">
        <a class="nav-link" href="{{ route('varieties.index') }}">
          <i class="material-icons icon-sidebar"> Pt </i>
          <span class="sidebar-normal">{{ __('Varieties') }} </span>
        </a>
      </li>
      ...
      <li class="nav-item{{ $activePage == 'bill/7' ? ' active' : '' }}">
        <a class="nav-link" href="{{ route('bills' , $type = \App\Enums\BillTypeEnum::OrderBill ) }}">
          <i class="material-icons icon-sidebar"> Ob </i>
          <span class="sidebar-normal">{{ __('Order bill') }} </span>
        </a>
      </li>
      @endif
